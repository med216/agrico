...
public class Modelplante {
    String nameplante,description,search,photo,uid;
    ...
    public Modelplante(String nameplante, String description, String search, String photo, String uid,Integer maxtemp,Integer mintemp,Integer maxhum,Integer minhum) {
